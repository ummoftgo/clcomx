...
const catppuccinFrappe: ThemeDef = {
...
const nightfox: ThemeDef = {
  id: "nightfox", name: "Nightfox", dark: true,
  theme: {
    background: "#192330", foreground: "#cdcecf", cursor: "#cdcecf",
    ...
    brightBlack: "#575860", brightRed: "#d16983", brightGreen: "#8ebaa4",
    brightYellow: "#e0c989", brightBlue: "#86abdc", brightMagenta: "#baa1e2",
    brightCyan: "#7ad5d6", brightWhite: "#e4e4e5",
  },
};
...
const moonfly: ThemeDef = {
  id: "moonfly", name: "Moonfly", dark: true,
  theme: {
    background: "#080808", foreground: "#bdbdbd", cursor: "#9e9e9e",
    selectionBackground: "#1c1c1c",
    black: "#323437", red: "#ff5454", green: "#8cc85f", yellow: "#e3c78a",
    blue: "#80a0ff", magenta: "#cf87e8", cyan: "#79dac8", white: "#c6c6c6",
    brightBlack: "#949494", brightRed: "#ff5189", brightGreen: "#36c692",
    brightYellow: "#bfbf97", brightBlue: "#74b2ff", brightMagenta: "#ae81ff",
    brightCyan: "#85dc85", brightWhite: "#e4e4e4",
  },
};

const nightfly: ThemeDef = {
  id: "nightfly", name: "Nightfly", dark: true,
  theme: {
    background: "#011627", foreground: "#acb4c2", cursor: "#9ca1aa",
    selectionBackground: "#1d3b53",
    black: "#1d3b53", red: "#fc514e", green: "#a1cd5e", yellow: "#e3d18a",
    blue: "#82aaff", magenta: "#c792ea", cyan: "#7fdbca", white: "#a1aab8",
    brightBlack: "#7c8f8f", brightRed: "#ff5874", brightGreen: "#21c7a8",
    brightYellow: "#ecc48d", brightBlue: "#82aaff", brightMagenta: "#ae81ff",
    brightCyan: "#7fdbca", brightWhite: "#d6deeb",
  },
};

const gotham: ThemeDef = {
  id: "gotham", name: "Gotham", dark: true,
  theme: {
    background: "#0c1014", foreground: "#98d1ce", cursor: "#98d1ce",
    selectionBackground: "#0a3749",
    black: "#0c1014", red: "#c33027", green: "#26a98b", yellow: "#edb54b",
    blue: "#195465", magenta: "#4e5166", cyan: "#33859d", white: "#98d1ce",
    brightBlack: "#10151b", brightRed: "#d26937", brightGreen: "#081f2d",
    brightYellow: "#245361", brightBlue: "#093748", brightMagenta: "#888ba5",
    brightCyan: "#599caa", brightWhite: "#d3ebe9",
  },
};

const srcery: ThemeDef = {
  id: "srcery", name: "Srcery", dark: true,
  theme: {
    background: "#1c1b19", foreground: "#fce8c3", cursor: "#fbb829",
    selectionBackground: "#3a3a3a",
    black: "#1c1b19", red: "#ef2f27", green: "#519f50", yellow: "#fbb829",
    blue: "#2c78bf", magenta: "#e02c6d", cyan: "#0aaeb3", white: "#baa67f",
    brightBlack: "#918175", brightRed: "#f75341", brightGreen: "#98bc37",
    brightYellow: "#fed06e", brightBlue: "#68a8e4", brightMagenta: "#ff5c8f",
    brightCyan: "#2be4d0", brightWhite: "#fce8c3",
  },
};

const jellybeans: ThemeDef = {
  id: "jellybeans", name: "Jellybeans", dark: true,
  theme: {
    background: "#1e1e1e", foreground: "#e8e8d3", cursor: "#e8e8d3",
    selectionBackground: "#404040",
    black: "#929292", red: "#e27373", green: "#94b979", yellow: "#ffba7b",
    blue: "#97bedc", magenta: "#e1a3ee", cyan: "#00988e", white: "#dedede",
    brightBlack: "#888888", brightRed: "#ffa1a1", brightGreen: "#bddeab",
    brightYellow: "#ffd7a3", brightBlue: "#b5d4f1", brightMagenta: "#efcbf8",
    brightCyan: "#0ac9bd", brightWhite: "#ffffff",
  },
};

const tokyoNightMoon: ThemeDef = {
  id: "tokyo-night-moon", name: "Tokyo Night Moon", dark: true,
  theme: {
    ...
    blue: "#82aaff", magenta: "#c099ff", cyan: "#86e1fc", white: "#828bb8",
    brightBlack: "#444a73", brightRed: "#ff757f", brightGreen: "#c3e88d",
    brightYellow: "#ffc777", brightBlue: "#82aaff", brightMagenta: "#c099ff",
...
const githubLight: ThemeDef = {
  ...
  theme: {
    ...
    brightBlack: "#444d56", brightRed: "#cb2431", brightGreen: "#28a745",
...
const tokyoNightDay: ThemeDef = {
  ...
  theme: {
    ...
    black: "#8990b3", red: "#f52a65", green: "#587539", yellow: "#8c6c3e",
...
const oneLight: ThemeDef = {
  ...
  theme: {
    ...
    black: "#383a42", red: "#e45649", green: "#50a14f", yellow: "#c18401",
    blue: "#4078f2", magenta: "#a626a4", cyan: "#0184bc", white: "#fafafa",
    brightBlack: "#4f525e", brightRed: "#be5046", brightGreen: "#5f9563",
    brightYellow: "#c18401", brightBlue: "#3b5fc9", brightMagenta: "#a626a4",
    brightCyan: "#0184bc", brightWhite: "#ffffff",
  },
};

const oneHalfLight: ThemeDef = {
  id: "one-half-light", name: "One Half Light", dark: false,
  theme: {
    background: "#fafafa", foreground: "#383a42", cursor: "#383a42",
    selectionBackground: "#bfceff",
    black: "#383a42", red: "#e45649", green: "#50a14f", yellow: "#c18401",
    blue: "#0184bc", magenta: "#a626a4", cyan: "#0997b3", white: "#fafafa",
    brightBlack: "#4f525e", brightRed: "#df6c75", brightGreen: "#98c379",
    brightYellow: "#e5c07b", brightBlue: "#61afef", brightMagenta: "#c678dd",
    brightCyan: "#56b6c2", brightWhite: "#ffffff",
  },
};

const tomorrowLight: ThemeDef = {
...
const noctisLux: ThemeDef = {
  id: "noctis-lux", name: "Noctis Lux", dark: false,
  theme: {
    background: "#fcecc9", foreground: "#0c1a27", cursor: "#0c1a27",
    selectionBackground: "#e4d5b0",
    black: "#0c1a27", red: "#c6262e", green: "#218559", yellow: "#f37b26",
    blue: "#1655a2", magenta: "#813c8b", cyan: "#00897b", white: "#b8b8b8",
    brightBlack: "#8a8a8a", brightRed: "#f05060", brightGreen: "#0d9a00",
    brightYellow: "#ff936a", brightBlue: "#5eb6fc", brightMagenta: "#e64dbe",
    brightCyan: "#00d4cc", brightWhite: "#fcecc9",
  },
};

const kanagawaLotus: ThemeDef = {
  id: "kanagawa-lotus", name: "Kanagawa Lotus", dark: false,
  theme: {
    ...
    blue: "#4d699b", magenta: "#624c83", cyan: "#4e8ca2", white: "#dcd7ba",
    brightBlack: "#8a8980", brightRed: "#d7474b", brightGreen: "#6e915f",
    brightYellow: "#836f4a", brightBlue: "#6693bf", brightMagenta: "#624c83",
    brightCyan: "#5ea6a7", brightWhite: "#f2ecbc",
  },
};

const nightOwlLight: ThemeDef = {
  id: "night-owl-light", name: "Night Owl Light", dark: false,
  theme: {
    background: "#fbfbfb", foreground: "#403f53", cursor: "#403f53",
    selectionBackground: "#e0e0e0",
    black: "#011627", red: "#d3423e", green: "#2aa298", yellow: "#daaa01",
    blue: "#4876d6", magenta: "#403f53", cyan: "#08916a", white: "#7a8181",
    brightBlack: "#7a8181", brightRed: "#f76e6e", brightGreen: "#49d0c5",
    brightYellow: "#dac26b", brightBlue: "#5ca7e4", brightMagenta: "#697098",
    brightCyan: "#00c990", brightWhite: "#989fb1",
  },
};

const icebergLight: ThemeDef = {
  id: "iceberg-light", name: "Iceberg Light", dark: false,
  theme: {
    background: "#e8e9ec", foreground: "#33374c", cursor: "#33374c",
    selectionBackground: "#cdd1e6",
...
const dayfox: ThemeDef = {
  id: "dayfox", name: "Dayfox", dark: false,
  theme: {
    background: "#cdcecf", foreground: "#3d4551", cursor: "#3d4551",
    selectionBackground: "#b6beca",
    black: "#393b44", red: "#a5222f", green: "#396847", yellow: "#ac5402",
    blue: "#2848a9", magenta: "#6e33ce", cyan: "#287980", white: "#a8adb7",
    brightBlack: "#4d505c", brightRed: "#c94f6d", brightGreen: "#81b29a",
    brightYellow: "#dbc074", brightBlue: "#719cd6", brightMagenta: "#9d79d6",
    brightCyan: "#63cdcf", brightWhite: "#eaebf0",
  },
};

const zenbones: ThemeDef = {
  id: "zenbones", name: "Zenbones Light", dark: false,
  theme: {
    background: "#f0edec", foreground: "#2c2525", cursor: "#2c2525",
    selectionBackground: "#d9d3d3",
    black: "#2c2525", red: "#a8334c", green: "#4f6c31", yellow: "#944927",
    blue: "#286486", magenta: "#88507d", cyan: "#3b8992", white: "#f0edec",
    brightBlack: "#7d6f6f", brightRed: "#94253e", brightGreen: "#3f5a22",
    brightYellow: "#803d1c", brightBlue: "#1d5573", brightMagenta: "#7b3b70",
    brightCyan: "#2b717e", brightWhite: "#f0edec",
  },
};

const noctisLilac: ThemeDef = {
  id: "noctis-lilac", name: "Noctis Lilac", dark: false,
  theme: {
    background: "#f4efff", foreground: "#0c1a27", cursor: "#0c1a27",
    selectionBackground: "#e0d9f0",
    black: "#0c1a27", red: "#c6262e", green: "#218559", yellow: "#cc6b00",
    blue: "#1655a2", magenta: "#813c8b", cyan: "#00897b", white: "#b8b8b8",
    brightBlack: "#8a8a8a", brightRed: "#f05060", brightGreen: "#0d9a00",
    brightYellow: "#db8500", brightBlue: "#5eb6fc", brightMagenta: "#e64dbe",
    brightCyan: "#00d4cc", brightWhite: "#f4efff",
  },
};
...
export const DARK_THEMES: ThemeDef[] = [
  dracula, catppuccinMocha, catppuccinFrappe, solarizedDark, gruvboxDark,
  nord, tokyoNightStorm, kanagawa, everforestDark, monokai,
  oneDark, ayuDark, nightfox, rosePine, moonfly,
  nightfly, gotham, srcery, jellybeans, tokyoNightMoon,
];

export const LIGHT_THEMES: ThemeDef[] = [
  solarizedLight, catppuccinLatte, atomOneLight, gruvboxLight, githubLight,
  tokyoNightDay, everforestLight, ayuLight, rosePineDawn, oneLight,
  oneHalfLight, tomorrowLight, noctisLux, kanagawaLotus, nightOwlLight,
  icebergLight, dayfox, zenbones, noctisLilac,
];

export const ALL_THEMES: ThemeDef[] = [...DARK_THEMES, ...LIGHT_THEMES];
